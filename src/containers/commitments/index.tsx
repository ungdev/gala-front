...
const Commitments = () => (
  <div className="page-container" id="commitments">
    ...
    <p>
      La sécurité de chacun est notre priorité. Que cela soit pendant la soirée ou pour venir et repartir, il nous tient
      à cœur d'assurer la sécurité et de préserver la santé de chaque participant. Nous tenons donc à éviter également
      tout incident lié à la soirée.
    </p>
    ...
    <p className="supported-association">
      Cette année, nous avions choisi de renouveler notre soutien à Astrée, association œuvrant pour restaurer le lien
      social et rompre la solitude à tous les âges.
      <br />
      <br />
      ...
      bénévoles. Si vous souhaitez les aider, même occasionnellement, n'hésitez pas à les contacter sur leur site Web.
      Si vous souffrez vous-même d'isolement, Astrée est là pour vous accompagner, vous pouvez également les contacter
      sur leur site Web.
    </p>
    ...
    <p>
      L'aspect environnemental prend une importance grandissante dans la société d'aujourd'hui, et dans notre événement
      aussi. Une part de plus en plus conséquente de notre budget est ainsi allouée à cette composante. Que cela soit
      avant, pendant ou après notre événement, nous mettons en place toujours plus de dispositifs de réduction, de tri
