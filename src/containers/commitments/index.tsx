  ...
  return (
    <div className="page-container" id="commitments">
      ...
      <p>
        ...
        événement aussi. Une part de plus en plus conséquente de notre budget est ainsi allouée à cette composante. Que
        cela soit avant, pendant ou après notre événement, nous mettons en place toujours plus de dispositifs de
