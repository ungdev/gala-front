    ...
    <>
      ...
      <div className="page-container" id="commitments">
        <div className="section">
          <IllustratedText imageSrc={placeholderImageSrc} alignment="left" title="Prévention" titleAlignment="left">
            <p>
              La sécurité de chacun est notre priorité. Que cela soit pendant la soirée ou pour venir et repartir, il
            ...
            <p>
              ...
              événement aussi. Une part de plus en plus conséquente de notre budget est ainsi allouée à cette
              composante. Que cela soit avant, pendant ou après notre événement, nous mettons en place toujours plus de
              dispositifs de réduction, de tri et de valorisation des déchets.
            </p>
          </IllustratedText>
        </div>
        ...
        <div className="red section">
          <IllustratedText
            ...
            alignment="right"
            title="Soutien d'une association"
            titleAlignment="left">
            <p>
              ...
              <br />
              Ce soutien se traduit notamment en apportant une plus grande visibilité à l'association auprès du public
              que l'événement peut toucher.
              <br />
            </p>
            <p className="supported-association">
              ...
              d'hospitalisation.
              <br />
              L'association travaille actuellement à l'ouverture d'une nouvelle antenne à Troyes. Elle recherche donc
              des bénévoles. Si vous souhaitez les aider, même occasionnellement, n'hésitez pas à les contacter sur leur
              site Web. Si vous souffrez vous-même d'isolement, Astrée est là pour vous accompagner, vous pouvez
