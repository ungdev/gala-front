  ...
  render() {
    return (
			<div className="page-container" id="access">
				...
				<p>
					À partir de 21h30, une navette gratuite est mise en place entre l'arrêt de bus Beurnonville et le parking de l’UTT.
				</p>
				<ul>
					<li>Départs Beurnonville : 21h30 – 22h00 – 22h15 – 22h30 – 22h45 – 23h00 – 23h15 – 23h30 – 23h45 – 00h00 – 00h15 – 00h30</li>
				...
				<ul className="access-list">
					<li><i className="fas fa-angle-right"></i> Autoroute A5 : sortie n°20 (Sainte Savine)</li>
					<li><i className="fas fa-angle-right"></i> N60 direction Troyes</li>
					<li><i className="fas fa-angle-right"></i> Rocade de contournement</li>
					<li><i className="fas fa-angle-right"></i> Suivre Technopole de l’Aube</li>
				</ul>

				<p><strong>Depuis Reims</strong></p>
				<ul className="access-list">
					<li><i className="fas fa-angle-right"></i> Autoroute A26 : sortie n°21 (Saint Thibault)</li>
					<li><i className="fas fa-angle-right"></i> N71 direction Troyes</li>
					<li><i className="fas fa-angle-right"></i> Rocade de contournement</li>
					<li><i className="fas fa-angle-right"></i> Suivre Technopole de l’Aube</li>
				</ul>

				<p><strong>Depuis Dijon</strong></p>
				<ul className="access-list">
					<li><i className="fas fa-angle-right"></i> Autoroute A5 : sortie n°21 (Saint Thibault)</li>
					<li><i className="fas fa-angle-right"></i> N71 direction Troyes</li>
					<li><i className="fas fa-angle-right"></i> Rocade de contournement</li>
					<li><i className="fas fa-angle-right"></i> Suivre Technopole de l’Aube</li>
				</ul>
