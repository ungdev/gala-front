...
export default (
  <React.Fragment>
    <div className="billetterie_container">
      ...
      <p>
        <strong>
          Toute personne ne respectant pas le code vestimentaire de la soirée pourra se voir refuser l'entrée par les
          organisateurs.
        </strong>
      </p>
      ...
      <p>
        Une pièce d'identité (permis de conduire, carte d'identité ou passeport) ainsi que le billet sont nécessaires
        afin de pouvoir entrer au sein de l'événement (les places étant nominatives).
      </p>
      <p>
      ...
      <p>
        Les dispositifs dangereux tels que les armes à feu ou les armes blanches sont interdits à l'intérieur du Gala,
        sans exception.&nbsp;
