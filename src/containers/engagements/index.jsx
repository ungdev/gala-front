        ...
        return (
            <div className="page-container" id="access">
                ...
                <p>
                    ...
                    Que cela soit pendant la soirée ou pour venir et repartir, il nous tient à cœur d'assurer la sécurité et de préserver la santé de chaque participant. Nous tenons donc à éviter également tout incident lié à la soirée.
                </p>
                <p className="prevention-measure">
                    ...
                    Nous mettons également en place 3 autres dispositifs en partenariat avec des associations spécilisées dans ce domaine :
                    <ul>
                        <li>un stand de prévention et de sensibilisation tenu par l'Association Nationale de Prévention Alcoologie et Addictologie (<a href="https://www.anpaa.asso.fr/">ANPAA</a>)</li>
                        <li>la circulation dans la soirée de "Charlies", proposant de l'eau, des gâteaux secs ou juste de la conversation, en partenariat avec l'Association <a href="">Revivre</a></li>
                ...
                <p>
                    ...
                    <br />
                    Ce soutien se traduit notamment en apportant une plus grande visibilité à l'association auprès du publique que l'événement peut toucher, mais aussi par le don d'une partie de nos bénéfices lorsque cela nous est possible.
                    <br />
                </p>
                <p className="supported-association">
                    Cette année, nous avions choisi d'apporter notre soutien à <a href="https://www.astree.asso.fr/fr/">Astrée</a>, association œuvrant pour restaurer le lien social et rompre la solitude à tous les âges.
                    <br />
